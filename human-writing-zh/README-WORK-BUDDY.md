...
人话写作是一套中文“去 AI 味”写作技能。它不靠故意口语化或热词堆砌制造人味，而是在保留事实、立场和证据强度的前提下，删掉空话与模板，再按读者和场景把语气调到恰当的位置。
...
在 Work Buddy 的技能导入界面直接上传本 ZIP；如该版本不支持 ZIP 导入，解压后保留 `human-writing-zh` 这一层目录，并放入它的 skills 目录。
